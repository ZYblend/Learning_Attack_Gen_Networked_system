function workshop(attack_percentage,attack_type)
% clc
% clear
% close all
...
[Z_attack_data_rand,effect_index_rand,stealth_index_rand] = random_attack_dataset_gen(inp_size_dis,n_random_sim_samples,attack_percentage,policy_param,attack_type);
...
for i_epoch = 1:n_epoch
    ...
    try
        ...
        [Z_attack_data_gen,effect_index_gen,stealth_index_gen] = generator_attack_dataset_gen(gen_net,generate_generator_data_flag,inp_size,n_generator_sim_sample,attack_percentage,policy_param,attack_type);
...
[test_score_dis,test_score_sim,~,~,~,~] = Performance_evaluation(gen_net,stealth_net,effect_net,thresholds,tot_test,attack_percentage,policy_param,attack_type,true);
